...
export default function Landing() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      const data = await res.json().catch(() => ({}));
      if (res.ok) {
        if (data.token) localStorage.setItem('blazly_token', data.token);
      ...
      <div className="landing__card">
        ...
        <form className="landing__form" onSubmit={handleEmailAuth}>
          ...
          {isLogin ? (
            ...
            <p className="landing__google-hint">
              Sign up with email first. After creating your account, you can sign in with Google.
            </p>
          )}
        </form>
